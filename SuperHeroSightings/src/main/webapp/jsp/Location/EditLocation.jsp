...
<%-- 
    ...
    Created on : Jan 1, 2019, 7:56:33 PM
    Author     : kaminahar
--%>
...
padding: 0.5em;
    ...
    <p>Hello : ${pageContext.request.userPrincipal.name}
        ...
        <h3>Edit Location</h3>   
         ...
         <div id="EditLocationDiv"> 
 
             <sf:form class="form-horizontal" role="form" modelAttribute="getLocationByIdToEdit"
                ...
                <div class="form-group">
                    <label for="locDescrip" class="col-md-4 control-label">Description:</label>
                    <!-- path has to be the same as the field names in your DTO (variable name) -->
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="locationDescription"
                                  path="locationDescription" placeholder="locationDescription"/>
                ...
                <div class="form-group">
                    <label for="locAddress" class="col-md-4 control-label">Address:</label>
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="locationAddress"
                                  path="locationAddress" placeholder="locationAddress"/>
               ...
               <div class="form-group">
                    <label for="locLatitude" class="col-md-4 control-label">Latitude:</label>
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="locationLatitude"
                ...
                <div class="form-group">
                    <label for="locLongitude" class="col-md-4 control-label">Longitude:</label>
                    <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="locationLongitude"
